...
//    .font(UIFont.manropeRegular(12)),
//    .textColor(.contentPrimary),
//    .alignment(.left),
//]
//builder.text("Tôi đồng ý với").space()
//    .text("Điều khoản sử dụng", attributes: [.textColor(.linkPrimary)]).space()
//    .text("và xác nhận đã đọc hiểu").space()
//    .text("Chính sách quyền riêng tư", attributes: [.textColor(.linkPrimary)]).space()
//    .text("của GGLive")
//termAndPrivacyLabel.attributedText = builder.attributedString
import Foundation
