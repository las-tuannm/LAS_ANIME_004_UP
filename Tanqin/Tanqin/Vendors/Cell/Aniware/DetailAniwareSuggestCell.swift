...
class DetailAniwareSuggestCell: BaseCollectionCell {
    ...
    fileprivate let listCollectionView: UICollectionView = {
        ...
        view.registerItem(cell: AniwareSuggestCell.self)
        return view
    }()
...
extension DetailAniwareSuggestCell: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell: AniwareSuggestCell = collectionView.dequeueReusableCell(indexPath: indexPath)
...
extension DetailAniwareSuggestCell: UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        return AniwareSuggestCell.size(height: collectionView.size.height)
    }
}
