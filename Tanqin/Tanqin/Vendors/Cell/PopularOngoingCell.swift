...
class PopularOngoingCell: BaseCollectionCell {
...
extension PopularOngoingCell: UICollectionViewDelegate, UICollectionViewDataSource {
...
extension PopularOngoingCell: UICollectionViewDelegateFlowLayout {
