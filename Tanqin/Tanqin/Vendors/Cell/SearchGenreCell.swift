...
class SearchGenreCell: BaseCollectionCell {
    // MARK: - properties
...
extension SearchGenreCell: UICollectionViewDelegate, UICollectionViewDataSource {
...
extension SearchGenreCell: UICollectionViewDelegateFlowLayout {
