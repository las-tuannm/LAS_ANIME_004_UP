...
class DetailEpisodesCell: BaseCollectionCell {
    ...
    fileprivate let collectionView: UICollectionView = {
        ...
        view.registerItem(cell: DetailEpisodesPathCell.self)
        return view
    }()
...
extension DetailEpisodesCell: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell: DetailEpisodesPathCell = collectionView.dequeueReusableCell(indexPath: indexPath)
...
extension DetailEpisodesCell: UICollectionViewDelegateFlowLayout {
