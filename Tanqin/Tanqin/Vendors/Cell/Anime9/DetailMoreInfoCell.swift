...
class DetailMoreInfoCell: BaseCollectionCell {
    ...
    fileprivate let scoresLabel = DetailInfoView()
    fileprivate let premieredLabel = DetailInfoView()
    fileprivate let durationLabel = DetailInfoView()
    fileprivate let qualityLabel = DetailInfoView()
    fileprivate let viewLabel = DetailInfoView()
    ...
    private func drawUIs() {
        ...
        viewInfo.addSubview(scoresLabel)
        viewInfo.addSubview(premieredLabel)
        viewInfo.addSubview(durationLabel)
        viewInfo.addSubview(qualityLabel)
        viewInfo.addSubview(viewLabel)
        ...
        premieredLabel.snp.makeConstraints { make in
            make.leading.trailing.equalToSuperview()
            make.top.equalTo(self.scoresLabel.snp.bottom).offset(0)
            make.height.equalTo(22)
        }
        ...
        qualityLabel.snp.makeConstraints { make in
            make.leading.trailing.equalToSuperview()
            make.top.equalTo(self.durationLabel.snp.bottom).offset(0)
            make.height.equalTo(22)
        }
        
        viewLabel.snp.makeConstraints { make in
            make.leading.trailing.equalToSuperview()
            make.top.equalTo(self.qualityLabel.snp.bottom).offset(0)
            make.height.equalTo(22)
        }
        
        genreLabel.snp.makeConstraints { make in
            make.leading.trailing.equalToSuperview()
            make.top.equalTo(self.viewLabel.snp.bottom).offset(0)
    ...
    func setValueForView() {
        ...
        scoresLabel.setText(title: "Scores:", detail: data?.scores ?? "")
        premieredLabel.setText(title: "Premiered:", detail: data?.premiered ?? "")
        durationLabel.setText(title: "Duration:", detail: data?.duration ?? "")
        qualityLabel.setText(title: "Quality:", detail: data?.quality ?? "")
        viewLabel.setText(title: "Views:", detail: data?.views ?? "")
    }
