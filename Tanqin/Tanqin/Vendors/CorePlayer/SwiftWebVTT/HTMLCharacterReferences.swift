...
struct HTMLCharacterReferences {
    ...
    static func standard() -> HTMLCharacterReferences {
        return HTMLCharacterReferences(
            named: ReferenceNamed.file("nameod"),
            substitute: ReferenceSubstitute.file("suti")
        )
    }
